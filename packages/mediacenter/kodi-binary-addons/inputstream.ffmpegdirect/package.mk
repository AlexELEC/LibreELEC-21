...
PKG_SHA256="fe57514db22f1151b9ec6ce050c98f13620c918a8bbc9c8a892341b829be0e58"
PKG_REV="1"
PKG_ARCH="any"
PKG_LICENSE="GPL2+"
...
post_patch() {
  # set version
  find ${PKG_BUILD} -name addon.xml.in -exec sed -i 's/version="21.3.3"/version="21.3.3.9"/g' {} \;
}
