...
PKG_SHA256="c3586c3af93f96c080ed8cb069bb6ef4f0a38dbd5b33f8c5166b03d84598f809"
PKG_REV="1"
PKG_ARCH="any"
PKG_LICENSE="GPL2+"
...
post_patch() {
  # set version
  find ${PKG_BUILD} -name addon.xml.in -exec sed -i 's/version="21.3.2"/version="21.3.2.9"/g' {} \;
}
